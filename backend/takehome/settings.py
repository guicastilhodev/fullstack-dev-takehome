...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-v#7ktx05a8uh!&cu)t1ugc$kh$d3%*1+9eyht33%j8l3ps853t')
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('POSTGRES_DB', 'quote_portal'),
...
# Ou para mais segurança, especifique origens específicas:
